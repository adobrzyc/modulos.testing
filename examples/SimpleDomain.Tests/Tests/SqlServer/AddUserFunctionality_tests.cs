...
namespace SimpleDomain.Tests.SqlServer
{
    ...
    public class AddUserFunctionality_tests
    {
        private readonly SqlServerEnv<V1.Definition> _env;

        public AddUserFunctionality_tests(SqlServerEnv<V1.Definition> env)
        {
            _env = env;
        }
